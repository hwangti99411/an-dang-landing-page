      ...
      <div className="grid gap-10 rounded-[2rem] border border-white/10 bg-white/5 p-8 lg:grid-cols-[1fr_1fr] lg:p-10">
        <div>
          <SectionHeading
            ...
            title={
              locale === 'vi'
                ? 'Hiệu quả nhanh hơn, hình ảnh thương hiệu mạnh hơn.'
                : 'Faster execution, stronger brand presence.'
            }
            description={
              locale === 'vi'
                ? 'Chúng tôi không chỉ làm đẹp giao diện mà còn xây dựng một trải nghiệm có khả năng chuyển đổi, thuyết phục và nuôi dưỡng lead hiệu quả.'
                : 'We go beyond aesthetics to build an experience that converts, builds trust, and nurtures leads effectively.'
            }
          />
        </div>
